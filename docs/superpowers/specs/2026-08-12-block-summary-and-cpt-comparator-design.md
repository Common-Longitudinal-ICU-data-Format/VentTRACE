...
| `05_table_one.py` | — | `index_covariates.parquet` | `table1_by_agent_{block,index}_readable.csv`, `table1_by_agent_{block,index}.json` (P39), `figures/T1_life_support_by_window.png`, `figures/T2_source_coverage.png` |
