...
| `tests/test_block_row_contract.py` | The `p_num = 1` subset height equals `step02__index_paralytics_per_block.csv`'s ≥1-index total; `05` and `06` agree on N; every block-level column is constant within its block. |
