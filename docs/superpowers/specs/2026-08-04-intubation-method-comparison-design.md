...
|---|---|---|---|
| `ep_num` | int | 1 = index intubation, > 1 = reintubation, chronological by t₀ within the block | 997 episodes are > 1 |
...
A block contributes as many rows as it has candidate episodes. At MIMIC, 11,675 qualifying blocks hold one, 701 hold two, 99 hold three, with a tail to seven; 997 of 13,500 qualifying episodes are reintubations.
