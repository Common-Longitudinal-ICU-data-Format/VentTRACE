...
CATALOG = [
    ...
    ("fig_1__main_consort.csv", "figure_data", "05_table_one", "1", "figure_1_df", "intermediate_phi/step04__index_covariates.parquet|final_no_phi/step02__paralytic_administration_summary.csv"),
